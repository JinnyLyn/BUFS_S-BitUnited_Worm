...
void InitialMessage() {
  ...
  printf(
      "\\_   ___ \\|__|_____ |  |__   ___________  _____________  ____    |__| "
      "____   _____/  |_          \\______   \\___.__.     |    |__| ____  \n");
  printf("/    \\  \\/|  \\____ \\|  |  \\_/ __ \\_  __ \\ \\____ \\_  __ \\/  "
         "_ \\   |  |/ __ \\_/ ___\\   __\\          |    |  _<   |  |     |   "
         " |  |/    \\ \n");
  printf("\\     \\___|  |  |_> >   Y  \\  ___/|  | \\/ |  |_> >  | \\(  <_> ) "
         " |  \\  ___/\\  \\___|  |            |    |   \\\\___  | /\\__|    | "
         " |   |  \\\n");
  printf(" \\______  /__|   __/|___|  /\\___  >__|    |   __/|__|   "
         "\\____/\\__|  |\\___  >\\___  >__|    ______  |______  // ____| "
         "\\________|__|___|  /\n");
  printf("        \\/   |__|        \\/     \\/        |__|               "
         "\\______|    \\/     \\/       /_____/         \\/ \\/               "
         "        \\/ \n");
...
int validate_selection(int min, int max) {
  ...
  if (fgets(input, sizeof(input), stdin) != NULL) {
    ...
    if (*endptr != '\0' || endptr == input || value < min || value > max) {
      fprintf(stderr,
              "Error!!! Invalid input.\nPlease enter a number between %d and "
              "%d!\nExiting ...\n",
              min, max);
      return -1;
    }
 ...
 * @param method Parameter for this function will determine the decryption
 * method.
 */
...
int main(void) {
  ...
  printf("What has been encrypted using this program is only decrypt-able with "
         "this one. (Ideally...)\n");
  ...
  case 1: // Encrypt
    printf(
        "Select encrypting method(#1 will be based on my own algorithm.): \n");
    // 암호화 방법 몇가지(base64 url 등등) 사용해보기.
    printf("[1]CIPHER\n[2]asdf\n[3]asdf\n[4]asdf\n[5]asdf\n");
    encrypt_method_selection =
        validate_selection(1, 5); // 함수 입력값은 선택지에 따라 바뀜
    ...
    break;
  case 2: // Decrypt
    printf("Select decrypting method(only choose 1 if you encrypted using this "
           "program.): \n");
    printf("[1]CIPHER\n[2]asdf\n[3]asdf\n[4]asdf\n[5]asdf\n");
    decrypt_method_selection =
        validate_selection(1, 5); // 함수 입력값은 선택지에 따라 바뀜
